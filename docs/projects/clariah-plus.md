...
The following repositories contain code to preprocess data, for NER annotations in particular.
...
* [voc-missives](https://github.com/cltl/voc-missives): extraction of TEI-formatted missives to UIMA CAS XMI and Conll
