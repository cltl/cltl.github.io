...
Code of our neural profiling machines built on top of background knowledge can be found in the repository [Profiling](Profiling/). Experiments where these profiling models are applied to establish identity of long-tail entities can be found [here](LongTailIdentity/). The annotation environment code for this project can be found [here](AnnotatingEntityProfiles/).
