...
## Performance on head and tail of WSD ([code](https://cltl.github.io/MoreIsNotAlwaysBetter/)
 we describe a set of experiments to analyze properties such as the volume, provenance, and balancing of training data in the framework of a state-of-the-art WSD system when evaluated on the SemEval-2013 English all-words dataset.
